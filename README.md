...
![Look of type homepage](https://github.com/nycalexander/type/blob/main/.github/hero-image.png)
...
![Example of switching font and theme](https://github.com/nycalexander/type/blob/main/.github/appearance.png)
...
![Installing PWA from Google Chrome](https://github.com/nycalexander/type/blob/main/.github/pwa-install.png)
...
Share bugs and ideas via [issues](https://github.com/nycalexander/type/issues). Any dialogs are also welcome at [nick@qurle.net](mailto:nick@qurle.net?subject=type.).
