...
*Type* is [open-source](https://github.com/nycalexander/type). Share bugs and ideas via [issues](https://github.com/nycalexander/type/issues). Any dialogs are also welcome at [nick@qurle.net](mailto:nick@qurle.net?subject=type.).
